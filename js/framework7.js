    ...
    window.Framework7 = function (params) {
        ...
        app.initSwipePanels = function () {
            ...
            function handleTouchMove(e) {
                ...
                if (!isMoved) {
                    ...
                    //修改兼容rem插件
                    if(document.documentElement.dataset.dpr){
                    	panelWidth = panel[0].offsetWidth/document.documentElement.dataset.dpr
                    }else{
        ...
        ************   Material Tabbar   ************
        ...
        app.initPageMaterialTabbar = function (pageContainer) {
            ...
            if (tabbar.length > 0) {
                //修改 添加tabbar no-span选项
                if (tabbar.find('.tab-link-highlight').length === 0 && tabbar.attr('class').indexOf('no-span') == -1) {
...
//                  style="width: ' + diameter + 'px; height: '+diameter+'px; margin-top:-'+diameter/2+'px; margin-left:-'+diameter/2+'px; left:'+center.x+'px; top:'+center.y+'px;"
                );
